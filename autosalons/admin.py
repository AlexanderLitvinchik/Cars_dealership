...
class ShowroomAdmin(admin.ModelAdmin):
    list_display = ('name', 'location', 'balance', 'get_cars_and_quantity')
    ...
    def get_cars_and_quantity(self, obj):
        return ', '.join([f"{rel.car} ({rel.quantity})" for rel in obj.car_relationships.all()])

    get_cars_and_quantity.short_description = 'Cars'
